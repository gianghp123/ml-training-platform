    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-semibold text-[#3192fc] hover:underline flex items-center space-x-1 cursor-pointer"
            >
          ...
          {filteredPipelines.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-52 border border-dashed border-[#1F1F23] rounded-xl bg-[#141416]/20 p-6 text-center">
              ...
              <button
                ...
                className="bg-[#3f495d] text-[#e5e1e4] border border-[#1F1F23] px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-[#353437] transition-all flex items-center space-x-2 cursor-pointer"
              >
        ...
        <div className="space-y-4">
          {/* Datasets card */}
          <div className="bg-[#131315] border border-[#1F1F23] rounded-xl p-4 flex flex-col justify-between min-h-[170px]">
            ...
            <button
              ...
              className="text-left text-xs font-semibold text-[#3192fc] hover:underline flex items-center space-x-1 mt-2 pt-2 border-t border-[#1F1F23]/40 cursor-pointer"
            >
      ...
      <div className="bg-gradient-to-r from-[#141416] via-[#1c1c1f] to-[#141416] border border-[#1F1F23] rounded-xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden relative">
        ...
        <button
          onClick={handleCreatePipeline}
          className="bg-[#3192fc] hover:bg-[#3192fc]/90 text-white text-xs font-semibold px-4 py-2 rounded-lg flex items-center space-x-2 shrink-0 shadow-lg active:scale-95 transition-all self-end md:self-auto cursor-pointer"
        >
